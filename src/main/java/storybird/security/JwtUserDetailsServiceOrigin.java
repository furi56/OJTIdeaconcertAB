 ...
 */
@Service
public class JwtUserDetailsServiceOrigin implements UserDetailsService {
    ...
    public ToonflixUsers loadUserByUsername(String id, String userType) throws UsernameNotFoundException {
        ...
        //단순 가입 유저 정보 조회 기능(select * from member where mem_id = id)
        MemberVo userInfo = memberDao.selectMemberById(id, userType);
